defmodule StrawHat.Review.ReviewTag do
  @moduledoc """
  Represents a Review Tags Ecto Schema relation.
  """

  use StrawHat.Review.Schema
  alias StrawHat.Review.{Review, Tag}

  @typedoc """
  - `review`: `t:StrawHat.Review.Review.t/0` associated with the current review tag.
  - `review_id`: The `review_id` is a reference to Review schema.
  - `tag`: `t:StrawHat.Review.Tag.t/0` associated with the current review tag.
